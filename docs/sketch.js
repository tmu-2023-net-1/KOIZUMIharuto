...
function draw() {
  ...
  let endings = "ENDINGS";
  let endingsWidth = textWidth(endings);
  ...
  if(enidingBool) {
    textAlign(RIGHT, TOP);
    text(endings, worldX[0] + storyWidth - width, worldY[0] + 100);
  }
