...
function draw() {
  ...
  if(backgroundBlack >= 255){
    if(!enidingBool) {
      if( worldX[0] - prorogueWidth/2 + textWidth(prorogue) < width*3/4 || millis() - startTime > 100) {
      ...
      if(worldX[0] - prorogueWidth/2 + textWidth(prorogue) - textWidth(reverseEnding) > width/4 || millis() - startTime > 100) {
